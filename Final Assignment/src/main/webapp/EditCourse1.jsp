...
<html>
	...
	<body>
		...
		<form class="form-horizontal" action="/CombinedAssignment/EditCourse2">
			...
			<!-- Text input-->
			<div class="form-group">
			  <label class="col-md-4 control-label">Enter Duration</label>  
			  <div class="col-md-4">
			...
			<div class="form-group">
			  ...
			  <div class="col-md-4">
			  <input id="admissionProcess" name="admissionProcess" type="text" placeholder="Enter process of admission" class="form-control input-md" required>
			  </div>
			</div>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-4">
			  <input id="eligibiltyCriteria" name="eligibilityCriteria" type="text" placeholder="Minimum Percentage Required" class="form-control input-md" required>
			  </div>
			</div>
