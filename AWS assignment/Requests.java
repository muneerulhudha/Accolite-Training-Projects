...
public class Requests {
    ...
    public void submitRequests() {
        ...
        launchSpecification.setImageId("ami-1b3b462b");
        launchSpecification.setInstanceType("t1.micro");
        launchSpecification.setUserData(getUserData());
        // Add the security group to the request.
        ArrayList<String> securityGroups = new ArrayList<String>();
        securityGroups.add("Muneer_SG");
    ...
    private static String getUserData(){
        ...
        lines.add("#! /bin/bash");
        lines.add("echo \"Hamid muneerulhudhakalvathi. \n Sample file to copy.\" > filetocopy.txt");
        lines.add("rm ~/.aws/config");
        lines.add("echo \"[default]");
        lines.add("region = us-west-2");
        lines.add("aws_access_key_id = AKIAIDFZBCCFXKQYGM4A");
        lines.add("aws_secret_access_key = 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\" > ~/.aws/config");
        lines.add("aws --region us-west-2 s3 cp filetocopy.txt s3://muneer.hudha/Muneer.txt");
        lines.add("ls");
